...
export default function LandingPage() {
  ...
  // Scroll-Triggered Animations for Features and CTA
  useEffect(() => {
      ...
      <nav className="fixed top-0 w-full h-20 bg-paper-100 dark:bg-abyss-900 border-b border-glass-border flex items-center justify-between px-8 z-50 transition-colors duration-500">
        ...
        <div className="flex items-center gap-6">
          ...
          <button 
            ...
            className="hidden md:flex items-center gap-2 px-6 py-2.5 bg-ink-900 dark:bg-paper-100 text-paper-100 dark:text-ink-900 font-bold rounded-xl hover:scale-105 transition-transform shadow-lg"
          >
            Launch App
          </button>
        </div>
